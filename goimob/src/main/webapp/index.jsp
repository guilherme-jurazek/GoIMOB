            ...
            <div>
                <div>
                    <form class="form-login">
                        ...
                        <a href="PainelControle.js"><input class="btn-login" type="submit" value="Login"></a>
                    </form>
                </div>
                <div>
                    <p class="text-modal">Ou entre usando:</p>
                    <div> 
                        <img class="img-google" src="Assets/GoogleIcon.png" width="60px;"> 
                        <img class="img-face" src="Assets/FaceIcon.png" width="60px"> 
                    </div>
                </div>
                <div>
