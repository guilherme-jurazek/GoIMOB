            ...
            <form class="form-gerar" action="in" method="post">
                <div class="row">
                    <div class="col">
                        ...
                        <input class="input-form-cadastro" type="text" placeholder="João Batista" name="name" id="nameCad" required>
                    </div>
                    <div class="col">
                        <label for="cepCad"><p class="text-form">Cep</p></label>
                        <input class="input-form-cadastro" type="text" placeholder="00000-000" name="cep" id="cepCad" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="emailCad"><p class="text-form">E-mail</p></label>
                        <input class="input-form-cadastro" type="text" placeholder="example@example.com" name="email" id="emailCad" required>
                    </div>
                    <div class="col">
                        <label for="foneCad"><p class="text-form">Número Residencial</p></label>
                        <input class="input-form-cadastro" type="text" placeholder="Exemplo: 25" name="nresidencia" id="foneCad" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="senhaCad"><p class="text-form">Senha</p></label>
                        <input class="input-form-cadastro" type="password" placeholder="1234Abc" name="senha" id="senhaCad" required>
                    </div>
                    <div class="col">
                        <label for="cpfCad"><p class="text-form">CPF</p></label>
                        <input  class="input-form-cadastro" type="text" placeholder="Exemplo: 000.000.000-00" name="cpf" id="cpfCad" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="confirmasenhaCad"><p class="text-form">Confirmar Senha</p></label>
                        <input class="input-form-cadastro" type="password" placeholder="1234Abc" name="" id="confirmasenhaCad" required>
                    </div>
                    <div class="col">
                ...
                <div class="row submit-form">
                    <div class="col">
                        <label class="form-check-label check-terms" for="termoCad">
                            <input type="checkbox" class="form-check-input" name="optradio" id="termoCad" required>Aceito os <a class="terms">Termos e Condições</a>
                        </label>
                    </div>
                    <div class="col">
                        <input type="submit" class="btn-gerar" required value="Cadastrar"><a href="cadastro.jsp"></a></input>
                    </div>
                </div>
